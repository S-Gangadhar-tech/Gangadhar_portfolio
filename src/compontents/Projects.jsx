    ...
    const projectsData = [
        {
            ...
            date: "July 2025",
            liveLink: "https://drivelocker-ui.vgcodes.online/",
            githubLink: "https://github.com/S-Gangadhar-tech/Drive_Locker",
            serverAPI: "https://drivelocker-api.vgcodes.online/api/v1.0/swagger-ui/index.html#/",
            dockerPublicImage:
    ...
    return (
        ...
        >
            <div className="container mx-auto px-4">
                ...
                {/* FIX: no viewport or whileInView */}
                <motion.div
                    className="flex flex-col gap-10 md:gap-12 max-w-4xl mx-auto"
  ...
  "
                                        ...
                                        {project.liveLink && (
                                            <a
                                                ...
                                                className="flex items-center space-x-2 px-4 md:px-6 py-2 md:py-3 font-semibold text-white bg-blue-500 rounded-full hover:bg-blue-600 transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105"
                                            >
                                        ...
                                        {project.githubLink && (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="flex items-center space-x-2 px-4 md:px-6 py-2 md:py-3 font-semibold text-white bg-gray-700 rounded-full hover:bg-gray-800 transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105"
                                            >
                                        ...
                                        {project.serverAPI && (
                                            <a
                                                ...
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="flex items-center space-x-2 px-4 md:px-6 py-2 md:py-3 font-semibold text-white bg-indigo-500 rounded-full hover:bg-indigo-600 transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105"
                                            >
                                                <FaCode className="text-lg md:text-xl" />
                                                <span>Server API</span>
                                            </a>
                                        )}
                                        {project.dockerPublicImage && (
                                            <a
                                                href={project.dockerPublicImage}
                                                target="_blank"
                                                rel="noopener noreferrer"
                                                className="flex items-center space-x-2 px-4 md:px-6 py-2 md:py-3 font-semibold text-white bg-orange-500 rounded-full hover:bg-orange-600 transition-all duration-300 shadow-md hover:shadow-lg transform hover:scale-105"
                                            >
                                                <FaDatabase className="text-lg md:text-xl" />
